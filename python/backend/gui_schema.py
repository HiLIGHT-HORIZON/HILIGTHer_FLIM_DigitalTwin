        ...
        "regions": [
            {
                ...
                "elements": [
                    ...
                    {"id": "tab_images", "type": "controller_tab", "label": "MC Image validation"},
                    ...
                    {"id": "action_run", "type": "action_button", "label": "Run Analysis / Run Optimisation"},
                    {"id": "action_interrupt", "type": "action_button", "label": "Interrupt"},
                    {"id": "action_export", "type": "action_button", "label": "SAVE AS"},
                    {"id": "action_test", "type": "action_button", "label": "2D MC tests"},
                ],
            },
            {
                "id": "analysis_stack",
                ...
                "elements": [
                    ...
                    {"id": "widget_optimisation_history", "type": "plot", "label": "Optimisation History"},
                ],
            },
            {
                "id": "bottom_row",
