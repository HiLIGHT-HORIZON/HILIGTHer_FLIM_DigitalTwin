window.MANUAL_SEARCH_INDEX = [
  ...
  },
  {
    ...
    section: "Workflow",
    url: "run-optimisation.html",
    keywords: "run optimisation fisher compression direct mean f minimisation excitation optimisation throughput auc",
    body: "Detection-gate and excitation-profile optimisation workflow, objectives, intermediate displays, retained steps, and exported outputs."
  },
  {
    title: "2D MC tests",
    section: "Workflow",
    url: "mc-image-validation.html",
    keywords: "2d mc tests image validation fitted lifetime pixel inspector phasor validation repeats",
    body: "Synthetic image-generation workflow, validation geometry, fitting outputs, pixel inspector, and phasor inspection."
  },
  {
  ...
  },
  {
    ...
    section: "Manual",
    url: "search.html",
    keywords: "search find manual browser ctrl h support widget",
    body: "Client-side manual search designed to work in the floating support browser."
  },
  {
  ...
  },
  {
    ...
    section: "APIs",
    url: "apis.html",
    keywords: "service api fastapi http api desktop automation session save load diagnostics precision optimisation",
    body: "Detailed backend service methods, HTTP endpoints, request shapes, and automation surfaces."
  },
  {
    title: "MCP guide",
    section: "MCP",
